...
def get_gl_entries(filters):
	...
	gl_entries = frappe.db.sql(
		...
		`tabGL Entry`.name as gl_entry, `tabGL Entry`.account as account, `tabGL Entry`.party_type as party_type,
		`tabGL Entry`.party as party,
		`tabGL Entry`.voucher_type as voucher_type, `tabGL Entry`.voucher_no as voucher_no,
		`tabGL Entry`.cost_center as cost_center, `tabGL Entry`.project as project,
		`tabGL Entry`.against_voucher_type as against_voucher_type,
		...
		`tabGL Entry`.is_opening as is_opening {select_fields}
		from `tabGL Entry`
...
def get_data_with_opening_closing(filters, account_details, gl_entries):
	...
	# for d in data:
	# 	if 'voucher_type' == 'PaymentEntry':
	# 		pe_doc= frappe.get_doc("Payment Entry",d.voucher_no)
	# 		data.update({'reference_date':pe_doc.reference_date})
	# 		data.append(pe_doc.reference_date)
	# 		print(data)
